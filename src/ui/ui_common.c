...
void ui_build_main_layout(UiMainLayout *layout) {
  ...
  layout->settings_options_w = 444.0f;
  layout->settings_options_h = layout->connection_h;
  layout->settings_options_row_x = layout->settings_options_x + 16.0f;
  layout->settings_options_row_w = layout->settings_options_w - 32.0f;
  layout->settings_options_row_h = layout->connection_row_h;
  layout->settings_options_row_gap = layout->connection_row_gap;
  layout->settings_options_first_row_y = layout->settings_options_y + 58.0f;
  layout->settings_back_button_x = layout->settings_options_row_x;
  layout->settings_back_button_y = layout->settings_options_y + layout->settings_options_h - 54.0f;
  ...
  layout->footer_status_w = 430.0f;
  layout->footer_hint_right_x = 928.0f;
  layout->footer_hint_w = 332.0f;
}
